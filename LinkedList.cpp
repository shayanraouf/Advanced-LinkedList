...
int main()
{
	/*int* intOne = new int(5);
	int* intTwo = new int(32);
	int* intThree = new int(43);
	int* intFour= new int(0);
	int* intFive = new int(0);
	int num;
	List342<int> l;
	l.Insert(intOne);
	l.Insert(intTwo);
	...
	//l.Insert(&s);
	//l.Insert(&k);
	string someString = "C:\\Users\\shayanraouf\\Desktop\\meow.txt";
	bool f = l.BuildList(someString);
	cout << l << endl;
	//cout << "num: " << num << endl;*/
